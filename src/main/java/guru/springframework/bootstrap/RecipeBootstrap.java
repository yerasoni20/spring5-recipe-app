...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<Unit_of_Measure> eachUomOptional = unitOfMeasureRepository.findByDescription("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Unit_of_Measure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Unit_of_Measure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Unit_of_Measure> dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Unit_of_Measure> pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<Unit_of_Measure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        ...
        //get optionals
        Unit_of_Measure eachUom = eachUomOptional.get();
        Unit_of_Measure tableSpoonUom = tableSpoonUomOptional.get();
        Unit_of_Measure teapoonUom = teaSpoonUomOptional.get();
        Unit_of_Measure dashUom = dashUomOptional.get();
        Unit_of_Measure pintUom = pintUomOptional.get();
        Unit_of_Measure cupsUom = cupsUomOptional.get();
